...
const resources = {
  es: {
    translation: {
      ...
      clickToChangePhoto: "Haz clic para cambiar tu foto. Máximo 5MB.",
      fullName: "Nombre completo",
      enterFullName: "Ingresa tu nombre completo",
      emailAddress: "Correo electrónico",
      emailCannotModify: "El correo electrónico no se puede modificar por seguridad",
      saveChanges: "Guardar cambios",
      saving: "Guardando...",
      aboutPersonalInfoTitle: "Sobre tu información personal",
      aboutPersonalInfoBody: "Tu información personal está protegida y solo tú puedes verla y modificarla. Nunca compartiremos tus datos con terceros sin tu consentimiento explícito.",
      ...
      MessagePlaceholder: "Recordar pagar suscripción",
      ScheduleNotification: "Programar notificación",
      ScheduleNotificationHint: "Al activar, recibirás una notificación local en la fecha y hora seleccionadas. Asegúrate de conceder permisos de alarma si tu dispositivo lo requiere.",
      Save: "Guardar",
      Delete: "Eliminar",
      DeleteReminderTitle: "Eliminar recordatorio",
      DeleteReminderConfirm: "¿Estás seguro?",
      ...
      // Recordatorios list
      schedulingLimitedWarning: "La programación de recordatorios está limitada en este entorno (no hay soporte de triggers). Algunas funciones pueden no estar disponibles.",
      FilterAll: "Todos",
      ...
      alarmPermissionRequiredBody: 'Android requiere el permiso de "alarma exacta" para programar recordatorios en segundo plano. ¿Quieres abrir la configuración de permisos para habilitarlo?',
